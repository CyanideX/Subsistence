package oldStuff.common.particle.core;
...
public abstract class ParticleCore extends EntityFX {
    ...
    private static final ResourceLocation texture = new ResourceLocation(SubsistenceOld.RESOURCE_PREFIX + "textures/particles/particles.png");
