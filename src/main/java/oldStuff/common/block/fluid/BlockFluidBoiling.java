package oldStuff.common.block.fluid;
...
import oldStuff.common.block.prefab.SubsistenceBasicFluid;
import oldStuff.common.fluid.SubsistenceFluids;
import oldStuff.common.lib.client.EnumParticle;
import oldStuff.common.particle.SteamFX;
import oldStuff.common.util.SubsistenceDamageSource;
...
public class BlockFluidBoiling extends SubsistenceBasicFluid {
    ...
    public void registerBlockIcons(IIconRegister register) {
        stillIcon = register.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "fluid/boilingWater_still");
        flowingIcon = register.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "fluid/boilingWater_flow");
