package oldStuff.common.block.item;
...
import oldStuff.common.tile.machine.TileHammerMill;
import oldStuff.common.tile.machine.TileHandCrank;
...
public class ItemBlockCrank extends SubsistenceItemBlock {
    ...
    public void registerIcons(IIconRegister register) {
        icon = register.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "tools/handCrank");
    }
