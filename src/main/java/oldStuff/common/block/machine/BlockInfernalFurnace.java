...
public class BlockInfernalFurnace extends SubsistenceTileBlock {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float fx, float fy, float fz) {
        if (!world.isRemote && !player.isSneaking()) {
            ...
            if (player.getHeldItem() != null && player.getHeldItem().getItem() == Items.flint_and_steel) {
                ...
                player.openGui(SubsistenceOld.instance, GuiHandler.GUI_INFERNAL_FURNACE, world, x, y, z);
            }
        }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        icons[0] = iconRegister.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "machine/hellfireFurnace_side");
        icons[1] = iconRegister.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "machine/hellfireFurnace_front");
        icons[2] = iconRegister.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "machine/hellfireFurnace_front_ON");
        icons[3] = iconRegister.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "machine/hellfireFurnace_top");
    }
