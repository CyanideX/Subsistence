...
public class BlockInfernalLog extends BlockLog {
    ...
    public void registerBlockIcons(IIconRegister register) {
        icons = new IIcon[3];
        icons[0] = register.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "world/infernalLog");
        icons[1] = register.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "world/infernalLog_rich");
        icons[2] = register.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "world/infernalLog_top");
    }
