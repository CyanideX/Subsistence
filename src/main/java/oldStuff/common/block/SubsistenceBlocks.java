...
import oldStuff.common.block.core.BlockSpawnMarker;
import oldStuff.common.block.fluid.BlockFluidBoiling;
import oldStuff.common.block.item.ItemBlockCrank;
import oldStuff.common.block.item.ItemBlockMetalShaft;
import oldStuff.common.block.item.ItemBlockWaterMill;
import oldStuff.common.block.machine.*;
import oldStuff.common.block.prefab.item.SubsistenceItemBlock;
import oldStuff.common.block.prefab.item.SubsistenceItemMultiBlock;
import oldStuff.common.block.prefab.item.SubsistenceMachineBlock;
import oldStuff.common.block.prefab.item.SubsistenceMultiMachineBlock;
...
public class SubsistenceBlocks {
    ...
    public static void initialize() {
        ...
        String prefix = SubsistenceOld.MODID + ".";
