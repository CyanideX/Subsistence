...
import oldStuff.common.block.prefab.SubsistenceBasicBlock;
...
public class BlockNetherGrass extends SubsistenceBasicBlock {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        side = iconRegister.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "world/netherGrass");
        top = iconRegister.registerIcon(SubsistenceOld.RESOURCE_PREFIX + "world/netherGrass_top");
    }
}
