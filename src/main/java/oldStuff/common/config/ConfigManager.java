...
public class ConfigManager {
    ...
    public static final File configDir = new File(SubsistenceOld.configPath);
    ...
    private static void genDefaultConfigs() {
        if (!recipeDir.exists()) {
            ...
            copyFromJar(SubsistenceOld.class, "subsistence/defaultrecipes.zip", to);
